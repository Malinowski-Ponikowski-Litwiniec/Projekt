...
public class AddProductWithFloatingButton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_with_floating_button);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              Intent intent = new Intent(AddProductWithFloatingButton.this,AddDailyProducts.class);
        ...
        myRef.child("lista").child(mAuth.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(AddProductWithFloatingButton.this, android.R.layout.simple_list_item_1, list);
                        ...
                        myRef.child("lista").child(list.get(position)).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(dataSnapshot.getValue() == null){
                                    Toast.makeText(AddProductWithFloatingButton.this,"Brak danych",Toast.LENGTH_SHORT).show();
                                }else {
                                    arrayList.add(dataSnapshot.getValue());
                                    ArrayAdapter<String> secondArrayAdapter = new ArrayAdapter<String>(AddProductWithFloatingButton.this, android.R.layout.simple_list_item_1, arrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.settings) {
            Toast.makeText(AddProductWithFloatingButton.this, "settings", Toast.LENGTH_SHORT).show();
            return true;
        }
        if (item.getItemId() == R.id.logOut) {
            ...
            builder.setPositiveButton("Tak", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    mAuth.signOut();
                    Intent intent = new Intent(AddProductWithFloatingButton.this, EmailPasswordActivity.class);
                    startActivity(intent);
                }
            });
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position) {
                            case 1:
                                break;
                            case 2:
                                intent = new Intent(AddProductWithFloatingButton.this, UserProfile.class);
                                startActivity(intent);
                                break;
                            case 3:

                                intent = new Intent(AddProductWithFloatingButton.this, EditActivity.class);
                                startActivity(intent);
                                break;
                            case 4:
                                intent = new Intent(AddProductWithFloatingButton.this, AddProductToDatabase.class);
                                startActivity(intent);
                                break;

                            case 5:
                                intent = new Intent(AddProductWithFloatingButton.this, AddActivityToDatabase.class);
                                startActivity(intent);
                                break;

                            case 6:
                                intent = new Intent(AddProductWithFloatingButton.this, AddDailyProducts.class);
                                startActivity(intent);
                                break;
                            case 7:
                                intent = new Intent(AddProductWithFloatingButton.this, AddDailyActivity.class);
                                startActivity(intent);
                                break;
                            case 8:
                                intent = new Intent(AddProductWithFloatingButton.this, EditAddedActivity.class);
                                startActivity(intent);
                            default:
                                break;
                        }
