                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position) {
                            ...
                            case 4:
                                ...
                                intent = new Intent(EditAddedActivity.this, CurrentList.class);
                                startActivity(intent);
                                break;
                            case 5:

                                intent = new Intent(EditAddedActivity.this, GraphActivity.class);
                                startActivity(intent);
                                break;
                            case 6:

                                intent = new Intent(EditAddedActivity.this, SelectDate.class);
                                startActivity(intent);
                                break;
                            default:
